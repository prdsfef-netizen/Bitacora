                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Hora</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($horario as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->hora }}</td>
                                        <td>
                                            <a href="{{ url('/horario/' . $item->id) }}" title="View Horario"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/horario/' . $item->id . '/edit') }}" title="Edit Horario"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>

                                            <form method="POST" action="{{ url('/horario' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
